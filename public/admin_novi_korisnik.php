...
if (isset($_POST['submit'])) {
	...
	if (!empty($errors)) {
		...
		redirect_to("admin_korisnici.php");
	}
...
<div class="container">
	...
	<div class="container">
	    ...
	    <div class="style-nav"></div>
			...
			<form id="novi_korisnik" action="admin_novi_korisnik.php" method="post" name="novi_korisnik">	
				<ul>
					<li>
...
<!-- footer -->
<?php include("../includes/layouts/footer_admin_novi_korisnik.php"); ?>
