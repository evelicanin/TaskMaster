	    ...
	    <div class="style-nav"></div>
			...
			<nav class="col-full cl-effect-1">
				...
				<a class="effect" href="admin_reports.php">
				    <span class="dr-icon dr-icon-chart4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Izvještaji</span>
				</a>

				<div class="style-zero"></div>
				<div class="style-one"></div>

				<a class="effect" href="admin_novi_korisnik.php">
				    <span class="dr-icon dr-icon-users">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Novi Korisnik</span>
				</a>

				<div class="style-zero"></div>
				<div class="style-one"></div>

				<a class="effect" href="admin_novi_task.php">
				    <span class="dr-icon dr-icon-file-text2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Novi Task</span>
				</a>

				<div class="style-zero"></div>
				<div class="style-one"></div>

				<a class="effect" href="admin_novi_operater.php">
				    <span class="dr-icon dr-icon-head">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Novi Operater</span>
				</a>
