...
<!-- dohvatamo sve korisnike (da bi ih prikazali u tabeli -->
<?php 
//$_SESSION["message"] = "";
//inicijalizacija poruke, tj. postavljamo da je prazna, da je nema
...
<div class="container">
	...
	<header id="navtop">
		<a href="admin.php" class="logo fleft">
			<img src="img/logo2.png" id="logoimg" alt="Designa Studio">
	...
	<div class="container">	    
	    <div class="style-nav"></div>
			...
			<a  href="admin_novi_korisnik.php"
