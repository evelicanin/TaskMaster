...
$taskovi_set = find_all_taskovi_operatera($logovani_korisnik); // svi taskovi iz baze koji pripadaju logovanom operateru
?>
...
<div class="container">
			...
			<a  href="operater_novi_task.php"
				...
				<?php $id_task = $task["id_task"]; ?>
				  <tr>
					...
					<td><?php echo '<a href="'. 'task_operater.php?id_task='.$id_task. '">' .htmlentities($task["naslov"]).'</a>'; ?></td>
    ...
    <div class="style-nav"></div>
		<p class="fright dr-icon dr-icon-user">
			<?php echo $ime_i_prezime["ime_prezime"] ?>: <span class="blue">operater</span>
		</p>
</div>
<!-- footer -->
