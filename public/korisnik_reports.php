...
<?php
$korisnici_statistika = korisnik_statistika();
?>
	...
	<div class="container">
	    <div class="style-nav"></div>
			...
			<div class="panel panel-primary">
				...
				<?php
					while($korisik_stat = mysqli_fetch_assoc($korisnici_statistika))
					{

						echo '<div class="panel panel-operater">';
							echo '<div class="panel-heading">';
							  echo '<h3 class="panel-title">'.htmlentities($korisik_stat["IME_PREZIME"]).' : ukupno taskova : '.htmlentities($korisik_stat["UKUPNO"]).'</h3>';
							echo '</div>';
					    echo '<div class="panel-body">';
										...
										echo 'OTVORENI TASKOVI : '.htmlentities($korisik_stat["OTVORENO"]);
										echo '<div class="style-data-black"></div>';
										echo 'ANALIZIRANI TASKOVI : '.htmlentities($korisik_stat["ANALIZIRANO"]);
										echo '<div class="style-data-black"></div>';
										echo 'PRIHVACENI TASKOVI : '.htmlentities($korisik_stat["PRIHVACENO"]);
										echo '<div class="style-data-black"></div>';
										echo 'ODBIJENI TASKOVI : '.htmlentities($korisik_stat["ODBIJENO"]);
										echo '<div class="style-data-black"></div>';
										echo 'ZAVRSENI TASKOVI : '.htmlentities($korisik_stat["ZAVRSENO"]);
										echo '<div class="style-data-black"></div>';
