...
if (isset($_POST['submit'])) {
	...
	$ope = 1; // nedodijeljeni task : id operatera no_operater je 1

				
	if (!empty($errors)) {
		$_SESSION["errors"] = $errors;
		redirect_to("operater_taskovi.php");
	}
...
<div class="container">
	...
	<div class="container">
	    ...
	    <div class="style-nav"></div>
			...
			<form id="novi_task" action="operater_novi_task.php" method="post" name="novi_task">	
				<ul>
					<li>
...
<!-- footer -->
<?php include("../includes/layouts/footer_operater_novi_task.php"); ?>